...
namespace ServoCommander
{
    public class IKSolverEx : IIKSolver
    {
        ...
        public IKLegResult LegIK(byte legNumber, double feetPosX, double feetPosZ, double feetPosY)
        {
            ...
            result.Result.Femur = IKMath.CheckBoundsAndSign(-(IKA1 + IKA2) * 180 / Math.PI + 90, HexConfig.FemurMin, HexConfig.FemurMax, HexConfig.FemurAngleInv[legNumber]);
            ...
            result.Result.Tibia = IKMath.CheckBoundsAndSign(-(90 - AngleRad4 * 180 / Math.PI), HexConfig.TibiaMin, HexConfig.TibiaMax, HexConfig.TibiaAngleInv[legNumber]);
